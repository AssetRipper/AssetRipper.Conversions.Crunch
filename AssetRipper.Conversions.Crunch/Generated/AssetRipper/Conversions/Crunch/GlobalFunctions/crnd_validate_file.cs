...
internal static partial class crnd_validate_file
{
	public unsafe static bool Invoke(void* pData, int data_size, void* pFile_info)
	{
		...
		unchecked
		{
			...
			ptr3 = crnd_get_header.Invoke(&crnd_crn_header, ptr2, num);
			if (ptr3 == null)
			{
				return false;
			}
			...
			if (operator_unsigned_int_neugqod.Invoke(&((crnd_crn_header*)ptr3)->field_9) < 0 || operator_unsigned_int_neugqod.Invoke(&((crnd_crn_header*)ptr3)->field_9) >= 11)
			{
				return false;
			}
			if (ptr != null)
