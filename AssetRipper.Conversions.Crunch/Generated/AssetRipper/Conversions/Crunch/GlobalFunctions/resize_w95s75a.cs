	...
	public unsafe static bool Invoke(void* @this, int new_size)
	{
		...
		unchecked
		{
			if (((crnd_vector_8*)@this)->field_1 != startFrame.GetLocalsPointer<LocalVariables>()->field_1)
			{
				...
				{
					destruct_array_l9jmj2b.Invoke(n: ((crnd_vector_8*)@this)->field_1 - startFrame.GetLocalsPointer<LocalVariables>()->field_1, p: (byte*)((crnd_vector_8*)@this)->field_0 + (nint)(uint)startFrame.GetLocalsPointer<LocalVariables>()->field_1 * (nint)2);
				}
				else
				{
