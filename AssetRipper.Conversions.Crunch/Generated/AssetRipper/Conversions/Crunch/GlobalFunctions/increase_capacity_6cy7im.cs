...
internal static partial class increase_capacity_6cy7im
{
	...
	public unsafe static bool Invoke(void* @this, [NativeType("unsigned int")] int min_new_capacity, [NativeType("bool")] bool grow_hint, [NativeType("unsigned int")] int element_size, [NativeType("void (__cdecl *)(void *, void *, unsigned int)")] void* pMover)
	{
		...
		unchecked
		{
			...
			{
				crnd_assert.Invoke(String_hnvvcq.__pointer, String_vvx8bt.__pointer, 2123);
			}
			if ((uint)min_new_capacity >= 2147418112u / (uint)element_size)
			{
				crnd_assert.Invoke(String_jfa7cs.__pointer, String_vvx8bt.__pointer, 2124);
			}
			...
			else
			{
				...
				{
					crnd_assert.Invoke(String_232tuz.__pointer, String_vvx8bt.__pointer, 2133);
				}
