...
internal static partial class increase_capacity_nb7lc5b
{
	...
	public unsafe static bool Invoke(void* @this, int min_new_capacity, bool grow_hint, int element_size, void* pMover)
	{
		...
		unchecked
		{
			...
			{
				crnd_assert.Invoke(String_vmviqdc.__pointer, String_yguirrd.__pointer, 2123);
				num = 0;
			}
			int num2;
			...
			{
				crnd_assert.Invoke(String_hbzy3qd.__pointer, String_yguirrd.__pointer, 2124);
				num2 = 0;
			}
			...
			else
			{
				...
				{
					crnd_assert.Invoke(String_rugjm7a.__pointer, String_yguirrd.__pointer, 2133);
					num3 = 0;
				}
