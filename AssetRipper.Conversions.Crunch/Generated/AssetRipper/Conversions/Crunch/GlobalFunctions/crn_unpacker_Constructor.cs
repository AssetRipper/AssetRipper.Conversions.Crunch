...
internal static partial class crn_unpacker_Constructor
{
	...
	public unsafe static void* Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			InlineArray_2_h3ee4zc* field_2 = &((crnd_crn_unpacker*)@this)->field_7;
			...
			while (true)
			{
				...
				if (ExceptionInfo.Current == null)
				{
					...
					InlineArray_2_h3ee4zc* field_3 = &((crnd_crn_unpacker*)@this)->field_8;
					...
					while (true)
					{
						...
						if (ExceptionInfo.Current == null)
						{
							...
							crnd_vector_5* field_4 = &((crnd_crn_unpacker*)@this)->field_9;
							vector_unsigned_int_Constructor.Invoke(field_4);
							if (ExceptionInfo.Current == null)
							{
								crnd_vector_5* field_5 = &((crnd_crn_unpacker*)@this)->field_10;
								vector_unsigned_int_Constructor.Invoke(field_5);
								if (ExceptionInfo.Current == null)
								{
									crnd_vector_8* field_6 = &((crnd_crn_unpacker*)@this)->field_11;
									...
									if (ExceptionInfo.Current == null)
									{
										...
										if (ExceptionInfo.Current == null)
										{
											void* field_7 = startFrame.GetLocalsPointer<LocalVariables>()->field_0;
