		...
		unchecked
		{
			...
			else
			{
				...
				else
				{
					...
					bool flag3 = resize_w95s75a.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors, num * 3);
					if (ExceptionInfo.Current != null)
					{
						goto IL_04d9;
					}
					...
					{
						void* ptr = vector_unsigned_short_Index.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors, 0);
						if (ExceptionInfo.Current != null)
						{
							goto IL_04d9;
						}
