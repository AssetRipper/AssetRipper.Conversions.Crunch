...
[CleanName("init")]
internal static partial class init_ijnwsj
{
	...
	public unsafe static bool Invoke(void* @this, [NativeType("unsigned int")] int total_syms, [NativeType("unsigned char const *")] void* pCode_sizes, [NativeType("unsigned int")] int code_size_limit)
	{
		...
		unchecked
		{
			...
			{
				crnd_assert.Invoke(String_tty2pe.__pointer, String_vvx8bt.__pointer, 2969);
			}
			num = minimum.Invoke(num, 16);
			bool flag = resize_zpvfc7.Invoke(&((crnd_static_huffman_data_model*)@this)->m_code_sizes, total_syms);
			...
			for (int i = 0; (uint)i < (uint)total_syms; i++)
			{
				...
				*(sbyte*)vector_unsigned_char_Operator_ggxbum.Invoke(&((crnd_static_huffman_data_model*)@this)->m_code_sizes, i) = (sbyte)num4;
			...
			bool flag2 = init_kvw3hm.Invoke(((crnd_static_huffman_data_model*)@this)->m_pDecode_tables, table_bits: compute_decoder_table_bits.Invoke(@this), pCodesizes: vector_unsigned_char_Operator_ggxbum.Invoke(&((crnd_static_huffman_data_model*)@this)->m_code_sizes, 0), num_syms: ((crnd_static_huffman_data_model*)@this)->m_total_syms);
			if (ExceptionInfo.Current != null)
			{
				return false;
			}
