...
internal static partial class unpack_dxn
{
	...
	public unsafe static bool Invoke(void* @this, [NativeType("unsigned char **")] void* pDst, [NativeType("unsigned int")] int dst_size_in_bytes, [NativeType("unsigned int")] int row_pitch_in_bytes, [NativeType("unsigned int")] int blocks_x, [NativeType("unsigned int")] int blocks_y, [NativeType("unsigned int")] int chunks_x, [NativeType("unsigned int")] int chunks_y)
	{
		...
		unchecked
		{
			int n = size_lxodu4b.Invoke(&((crnd_crn_unpacker*)@this)->field_11);
			int n2 = crn_packed_uint_2_ToUInt32.Invoke(&((crnd_crn_header*)((crnd_crn_unpacker*)@this)->field_4)->field_17.field_2);
			num = 0;
			num2 = 0;
			num3 = 0;
			num4 = 0;
				...
				for (int j = 0; (uint)j < (uint)chunks_y; j++)
				{
					...
					for (int k = num7; k != num8; k = checked(k + num9))
					{
						...
						for (int l = 0; (uint)l < (uint)num12; l++)
						{
							...
							num += num13;
							limit.Invoke(&num, n);
							Unsafe.As<InlineArray4_Int32, int>(ref Unsafe.AddByteOffset(ref inlineArray4_Int, (nint)(uint)l * (nint)4)) = (ushort)(*(short*)vector_unsigned_short_Index.Invoke(&((crnd_crn_unpacker*)@this)->field_11, num));
						}
						for (int m = 0; (uint)m < (uint)num12; m++)
						{
							int num14 = decode.Invoke(&((crnd_crn_unpacker*)@this)->field_5, (byte*)(&((crnd_crn_unpacker*)@this)->field_7) + sizeof(crnd_static_huffman_data_model));
							num3 += num14;
							limit.Invoke(&num3, n);
							Unsafe.As<InlineArray4_Int32, int>(ref Unsafe.AddByteOffset(ref inlineArray4_Int2, (nint)(uint)m * (nint)4)) = (ushort)(*(short*)vector_unsigned_short_Index.Invoke(&((crnd_crn_unpacker*)@this)->field_11, num3));
						}
						void* ptr3 = ptr2;
						for (int num15 = 0; (uint)num15 < 2u; num15++)
						{
							...
							while ((uint)num16 < 2u)
							{
								...
								int num18 = decode.Invoke(&((crnd_crn_unpacker*)@this)->field_5, (byte*)(&((crnd_crn_unpacker*)@this)->field_8) + sizeof(crnd_static_huffman_data_model));
								num4 += num18;
								limit.Invoke(&num4, n2);
								if ((num16 == 0 || (b2 & 1) != 1) && (num15 == 0 || (b & 1) != 1))
								{
									int num19 = (byte)((sbyte*)field_)[(uint)(num16 + num15 * 2)];
									void* ptr4 = vector_unsigned_short_Index.Invoke(&((crnd_crn_unpacker*)@this)->field_12, num2 * 3);
									void* ptr5 = vector_unsigned_short_Index.Invoke(&((crnd_crn_unpacker*)@this)->field_12, num4 * 3);
