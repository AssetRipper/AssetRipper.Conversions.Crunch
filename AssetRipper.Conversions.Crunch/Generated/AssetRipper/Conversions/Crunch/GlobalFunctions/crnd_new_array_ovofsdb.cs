...
internal static partial class crnd_new_array_ovofsdb
{
	...
	public unsafe static void* Invoke(int num)
	{
		...
		unchecked
		{
			void* field_ = crnd_malloc.Invoke(8L + 2L * (long)(uint)startFrame.GetLocalsPointer<LocalVariables>()->field_1, null);
			...
			else
			{
				...
				*(int*)((byte*)startFrame.GetLocalsPointer<LocalVariables>()->field_3 + -8) = num2;
				construct_array_pri7s5c.Invoke(n: startFrame.GetLocalsPointer<LocalVariables>()->field_1, p: startFrame.GetLocalsPointer<LocalVariables>()->field_3);
