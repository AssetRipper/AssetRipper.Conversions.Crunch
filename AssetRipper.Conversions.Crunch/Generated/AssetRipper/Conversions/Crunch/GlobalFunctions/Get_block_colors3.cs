...
internal static partial class Get_block_colors3
{
	...
	public unsafe static int Invoke([NativeType("class crnd::color_quad<unsigned char, int> *")] void* pDst, [NativeType("unsigned short")] short color0, [NativeType("unsigned short")] short color1)
	{
		...
		color_quad_unsigned_char_int_Assignment.Invoke(unchecked((byte*)pDst) + sizeof(crnd_color_quad), &crnd_color_quad3);
		set.Invoke(unchecked((byte*)pDst + (nint)2 * sizeof(crnd_color_quad)), blue: unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad2.field))->field_2) + unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad3.field))->field_2) >> 1, green: unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad2.field))->field_1) + unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad3.field))->field_1) >> 1, red: unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad2.field))->field_0) + unchecked((byte)((anon_m9uqrv*)(&crnd_color_quad3.field))->field_0) >> 1, alpha: 255);
