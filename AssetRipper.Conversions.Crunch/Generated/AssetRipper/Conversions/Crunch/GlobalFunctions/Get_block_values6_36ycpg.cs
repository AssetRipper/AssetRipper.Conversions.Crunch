...
internal static partial class Get_block_values6_36ycpg
{
	...
	public unsafe static int Invoke([NativeType("class crnd::color_quad<unsigned char, int> *")] void* pDst, [NativeType("unsigned int")] int l, [NativeType("unsigned int")] int h)
	{
		unchecked
		{
			...
			((anon_m9uqrv*)(&((crnd_color_quad*)pDst)[6L].field))->field_3 = 0;
			((anon_m9uqrv*)(&((crnd_color_quad*)pDst)[7L].field))->field_3 = -1;
			return 6;
		}
	}
}
