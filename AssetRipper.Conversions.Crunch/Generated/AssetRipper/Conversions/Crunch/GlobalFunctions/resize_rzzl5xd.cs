	...
	public unsafe static bool Invoke(void* @this, int new_size)
	{
		...
		unchecked
		{
			if (((crnd_vector*)@this)->field_1 != startFrame.GetLocalsPointer<LocalVariables>()->field_1)
			{
				...
				{
					destruct_array_dhbxund.Invoke(n: ((crnd_vector*)@this)->field_1 - startFrame.GetLocalsPointer<LocalVariables>()->field_1, p: (byte*)((crnd_vector*)@this)->field_0 + (uint)startFrame.GetLocalsPointer<LocalVariables>()->field_1);
				}
				else
				{
