...
internal static partial class init_lqqdgrc
{
	...
	public unsafe static bool Invoke(void* @this, void* pData, int data_size)
	{
		...
		unchecked
		{
			((crnd_crn_unpacker*)@this)->field_4 = crnd_get_header.Invoke(data_size: startFrame.GetLocalsPointer<LocalVariables>()->field_1, pData: startFrame.GetLocalsPointer<LocalVariables>()->field_2, tmp_header: &((crnd_crn_unpacker*)@this)->field_3);
