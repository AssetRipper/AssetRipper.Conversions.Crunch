...
internal static partial class pack_color_ej3cup
{
	...
	public unsafe static short Invoke([NativeType("class crnd::color_quad<unsigned char, int> const &")] void* color, [NativeType("bool")] bool scaled, [NativeType("unsigned int")] int bias)
	{
		...
		unchecked
		{
			int num2 = (byte)((anon_m9uqrv*)(&((crnd_color_quad*)color)->field))->field_0;
			int num3 = (byte)((anon_m9uqrv*)(&((crnd_color_quad*)color)->field))->field_1;
			int num4 = (byte)((anon_m9uqrv*)(&((crnd_color_quad*)color)->field))->field_2;
			if (((num ? 1u : 0u) & 1u) == 1)
			{
