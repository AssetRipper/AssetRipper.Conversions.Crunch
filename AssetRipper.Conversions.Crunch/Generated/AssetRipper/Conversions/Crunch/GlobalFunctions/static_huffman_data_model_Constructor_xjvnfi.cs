...
internal static partial class static_huffman_data_model_Constructor_xjvnfi
{
	public unsafe static void* Invoke(void* @this, [NativeType("class crnd::static_huffman_data_model const &")] void* other)
	{
		unchecked
		{
			...
			crnd_vector_uksit8* code_sizes = &((crnd_static_huffman_data_model*)@this)->m_code_sizes;
