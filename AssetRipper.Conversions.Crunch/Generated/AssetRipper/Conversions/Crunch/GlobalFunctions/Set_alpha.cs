...
internal static partial class Set_alpha
{
	...
	public unsafe static void Invoke(void* @this, [NativeType("unsigned int")] int x, [NativeType("unsigned int")] int y, [NativeType("unsigned int")] int value, [NativeType("bool")] bool scaled)
	{
		...
		unchecked
		{
			...
			{
				crnd_assert.Invoke(String_jsxkht.__pointer, String_vvx8bt.__pointer, 3460);
			}
			if ((b & 1) == 1)
			{
				if ((uint)num > 255u)
				{
					crnd_assert.Invoke(String_exh4qe.__pointer, String_vvx8bt.__pointer, 3464);
				}
				num = (int)((uint)(num * 15 + 128) / 255u);
			}
			else if ((uint)num > 15u)
			{
				crnd_assert.Invoke(String_sg8vgw.__pointer, String_vvx8bt.__pointer, 3469);
			}
			int num2 = (y << 1) + (x >>> 1);
