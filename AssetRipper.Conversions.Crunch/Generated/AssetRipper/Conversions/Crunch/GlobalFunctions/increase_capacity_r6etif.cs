...
internal static partial class increase_capacity_r6etif
{
	...
	{
		bool flag = increase_capacity_6cy7im.Invoke(@this, min_new_capacity, ((grow_hint ? 1u : 0u) & 1u) == 1, 4, null);
		...
		if (!flag)
		{
			unchecked((crnd_vector_rgfndh*)@this)->m_alloc_failed = 1;
			return false;
		}
		return true;
	}
